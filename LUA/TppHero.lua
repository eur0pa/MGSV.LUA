...
function e.OnFultonSoldier(o,i)local _=n(o,{id="GetStateFlag"})local r=n(o,{id="IsZombieOrMsf"})local n=n(o,{id="IsChild"})if r then
if i then
...
function e.SetAndAnnounceHeroicOgrePoint(n,i,o)if TppMission.IsFOBMission(vars.missionCode)and(vars.fobSneakMode==FobMode.MODE_SHAM)then
return
end
e.SetHeroicPoint(n.heroicPoint)e.AnnounceHeroicPoint(n,i,o)e.SetOgrePoint(n.ogrePoint)end
...
local n=r(n)local n=e.BREAK_GIMMICK[n]if n then
...
function e.OnHelicopterLostControl(o,n)local o=r(o)local n=Tpp.IsLocalPlayer(n)if o==TppGameObject.GAME_OBJECT_TYPE_HELI2 then
if n then
...
end},{msg="Dead",func=function(o,r,_,i)if r and Tpp.IsLocalPlayer(r)then
...
end},{msg="BreakGimmick",func=e.AnnounceBreakGimmick},{msg="VehicleBroken",func=function(o,n)if n==_"Start"then
e.AnnounceVehicleBroken(o)end
end},{msg="LostControl",func=function(i,o,n)if o==_"Start"then
...
function e.OnMessage(t,i,o,n,r,c,_)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,t,i,o,n,r,c,_)end
...
local e=TppMotherBaseManagement.GetHeroicPoint()if(e>=vars.mbmHeroThreshold)then
gvars.isHero=true
end

...
if o then
PlayRecord.RegistPlayRecord"BASE_SUPPRESSION"e.SetAndAnnounceHeroicOgrePointForAnnihilateCp(e.ON_ANNIHILATE_BASE,true)TppTrophy.Unlock(18)Tpp.IncrementPlayData"totalAnnihilateBaseCount"TppChallengeTask.RequestUpdate"ENEMY_BASE"end
TppEmblem.AcquireOnCommandPostAnnihilated(n)elseif TppEnemy.IsOuterBaseCp(n)then
if o then
e.SetAndAnnounceHeroicOgrePointForAnnihilateCp(e.ON_ANNIHILATE_OUTER_BASE,false)Tpp.IncrementPlayData"totalAnnihilateOutPostCount"TppChallengeTask.RequestUpdate"ENEMY_BASE"TppTrophy.Unlock(18)end

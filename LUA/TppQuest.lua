...
function e.OpenChildSoldier_1()local t=e.IsCleard"mtbs_q99050"local n=e.IsNowOccurringElapsed()local e=TppStory.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE)local a=TppStory.IsMissionCleard(10093)return((e or n)and t)and a
end
...
function t.mtbs_q99050()local e=TppLocation.GetLocalMbStageClusterGrade(TppDefine.CLUSTER_DEFINE.Develop+1)>=2
local t=TppStory.IsMissionCleard"10211"return t and e
end
function t.mtbs_q99011()local n=TppBuddy2BlockController.DidObtainBuddyType(BuddyType.QUIET)local t=TppStory.IsMissionCleard(10086)local e=TppStory.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.QUIET_VISIT_MISSION)return(n and t)and e
end
...
TppUiCommand.SetSideOpsListUpdate()for n,e in ipairs(m)do
if t==e then
...
local o,i=TppEnemy.GetQuestCount()local n,a=TppGimmick.GetQuestShootingPracticeCount()if o>0 and i>1 then
e.ShowAnnounceLog(s.UPDATE,t,o,i)elseif n>0 and a>1 then
...
function e.Messages()local o=e.DeactiveQuestAreaTrapMessages()return D{Block={{msg="StageBlockCurrentSmallBlockIndexUpdated",func=e.OnUpdateSmallBlockIndex}},UI={{msg="EndFadeOut",sender="FadeOutOnOutOfMissionArea",func=function()mvars.qst_blockStateRequest=i.DEACTIVATE
...
function e.OnMessage(i,n,t,s,a,o,r)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,i,n,t,s,a,o,r)local l=mvars.qst_questScriptBlockMessageExecTable
if l then
local e=r
local r
Tpp.DoMessage(l,TppMission.CheckMessageOption,i,n,t,s,a,o,e)end
...
local r=r
local l
Tpp.DoMessage(e,TppMission.CheckMessageOption,i,n,t,s,a,o,r)end
end
end
end
...
local function a(t,n,e)local a=(nil).Print
...
if e>0 and s>0 then
local o=n.qst_questList[e]if o then
local i=o.infoList[s]if i then
local e=TppDefine.QUEST_INDEX[i.name]gvars.qst_questOpenFlag[e]=n.debug.updateOpenFlagSelectQuest
...
a(t,"No define quest. index: "..tostring(s))end
end
end
...
function e.ResetQuestStatus()gvars.qst_currentQuestName=p
gvars.qst_currentQuestStepNumber=c
end
...
function e.SearchQuestFromAllSpecifiedArea(n,a,o,s)local t=#mvars.qst_questList
for t=1,t do
local t=mvars.qst_questList[t]if e.IsInsideArea(n,t,a,o,s)then
...
local n=nil
local n={}local a={}local s={}local i={}for t,o in ipairs(t.infoList)do
local t=o.name
local n=TppDefine.QUEST_INDEX[t]if n then
gvars.qst_questActiveFlag[n]=false
local n=r[t]if e.IsOpen(t)and(not n or n())then
if not e.IsCleard(t)then
if o.isStory then
table.insert(a,t)else
...
function e.SwitchActiveQuest(n)local t=a[n]if not t then
return
end
...
local e=e.name
local t=TppDefine.QUEST_INDEX[e]if t then
gvars.qst_questActiveFlag[t]=(e==n)end
end
end
end
end
...
function e.GetClearKeyItem(t)for e,n in pairs(I)do
if e==t then
TppTerminal.AcquireKeyItem{dataBaseId=n,isShowAnnounceLog=true}for t,n in pairs(C)do
if e==t then
...
function e.GetClearEmblem(e)local e=A[e]if e then
...
local n=f[t]local s,r=TppEnemy.GetQuestCount()local o,i=TppGimmick.GetQuestShootingPracticeCount()if n then
if s>1 then
TppUI.ShowAnnounceLog(n,s,r)elseif o>1 then
TppUI.ShowAnnounceLog(n,o,i)end
end
...
function e.HideAllShootingPracticeForUi()for t,e in pairs(T)do
...
local t={ruins_q60115=TppMotherBaseManagementConst.DESIGN_2027,sovietBase_q60110=TppMotherBaseManagementConst.DESIGN_2020,sovietBase_q60111=TppMotherBaseManagementConst.DESIGN_2024}local a={pfCamp_q39012={dataBaseId=TppMotherBaseManagementConst.ANIMAL_130,areaName="anml_quest_00"}}function e.AcquireKeyItemOnMissionStart()for t,n in pairs(I)do

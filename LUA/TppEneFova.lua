...
function a.GetHostageLangAtMissionId(e)local a=l
if t[e]~=nil then
local e=t[e]if e~=nil then
if e.lang~=nil then
return e.lang
...
elseif t==d then
table.insert(n,0)elseif t==p then
...
elseif t==i then
table.insert(n,1)elseif t==c then
...
local T=a.GetHostageIsFaceModelOverlap(o)local r=a.GetHostageIgnoreFaceList(o)local _=a.GetHostageFaceModelCount(o)local r=TppSoldierFace.CreateFaceTable{race=n,needCount=s,maxUsedFovaCount=_,faceModelOverlap=T,ignoreFaceList=r,raceHalfMode=f}if r~=nil then
...
table.insert(a,{100+n,0,0,e})elseif t==p then
table.insert(a,{210+n,0,0,e})elseif t==i then
table.insert(a,{9+n,0,0,e})elseif t==c then
...
n[10040]=function(a,e)local a=o(n)a:case("Afghan",e)TppSoldierFace.SetUseZombieFova{enabled=true}end
...
n[10052]=function(e,a)local e=o(n)e:case("Afghan",a)TppSoldierFace.SetSplitRaceForHostageRandomFaceId{enabled=true}end
...
local d=e[d]local t=e[a]local e={{TppEnemyFaceId.pfs_balaclava,2,2,0},{d,1,1,0},{t,1,1,0}}TppSoldierFace.OverwriteMissionFovaData{face=e,additionalMode=true}local a=265
local e=266
TppSoldierFace.SetSpecialFovaId{face={d,t},body={a,e}}local e={{a,1},{e,1}}TppSoldierFace.OverwriteMissionFovaData{body=e,additionalMode=true}end
...
TppSoldierFace.OverwriteMissionFovaData{body=n}TppSoldierFace.SetBodyFovaUserType{hostage={TppEnemyBodyId.prs2_main0_v00}}TppHostage2.SetDefaultBodyFovaId{parts=T,bodyId=TppEnemyBodyId.prs2_main0_v00}end
...
local d=(n%t)*2
local o=TppEnemyFaceGroupId.AFRICA_GRP000_B+(d)local i=a.GetFaceGroupTableAtGroupType(o)TppSoldierFace.OverwriteMissionFovaData{face=i}if l>0 then
for e=1,2 do
n=n+2
local e=(n%t)*2
...
d=(n%t)*2
o=TppEnemyFaceGroupId.AFRICA_GRP000_W+(d)local d=a.GetFaceGroupTableAtGroupType(o)TppSoldierFace.OverwriteMissionFovaData{face=d}if l>0 then
for e=1,2 do
n=n+2
local e=(n%t)*2
...
function a.AddTakingOverHostagePack()local e={}for n,t in ipairs(TppEnemy.TAKING_OVER_HOSTAGE_LIST)do
local a=n-1
if a>=gvars.ene_takingOverHostageCount then
break
end
local a={type="hostage",name=t,faceId=gvars.ene_takingOverHostageFaceIds[a]}table.insert(e,a)end
...
local c={}local o={}local l={}local t={}local d=0
local i=0
local s=0
local p=0
local r=0
...
function a.GetFaceIdForDdHostage(e)local n=d
d=d+1
...
function a.GetFaceId_s10081()return s
end
function a.GetFaceId_s10091_0()return p
end
...
function a.RegisterUniqueSetting(d,i,p,n)local e=EnemyFova.NOT_USED_FOVA_VALUE
local a,p=a.GetFaceIdAndFlag(d,p)if a==nil then
a=e
end
if n==nil then
n=e
...
local t=d(t,m)local a=a.GetStaffIdForDD(n,t)if a~=f then
...
function a.GetUavSetting()local d=TppMotherBaseManagement.GetMbsUavLevel{}local p=TppMotherBaseManagement.GetMbsUavSmokeGrenadeLevel{}local T=TppMotherBaseManagement.GetMbsUavSleepingGusGrenadeLevel{}local a=TppMotherBaseManagement.GetMbsClusterSecuritySoldierEquipGrade{}local f=TppMotherBaseManagement.GetMbsClusterSecurityIsNoKillMode()local l=TppUav.DEVELOP_LEVEL_LMG_0
local t=false
local c=false
local e=0
local n=0
